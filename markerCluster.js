...
this.setupStyles_();
        ...
        mapCenter = map.getCenter();
                // cluster icon disappears once max zoom is reached
...
MarkerClusterer.prototype.MARKER_CLUSTER_IMAGE_PATH_ = 'images/m';
        ...
        // setup only required number of styles
         ...
         */
        MarkerClusterer.prototype.getMarkerWeights = function() {
         ...
         */
        MarkerClusterer.prototype.getStateControl = function() {
         ...
         */
        MarkerClusterer.prototype.getClusterMetric = function() {
         ...
         *  @private
         */
        MarkerClusterer.prototype.calculator_ = function(markers, markerWeights) {
        // anirudhp - changed function signature for cluster banding
        var typeSum = 0;
                var metricSum = 0;
                var count = 0;
...
// anirudhp - added a function to convert large numbers to SI units
...
//Iterate through markers only once
//this.updateIcon();
                return true;
                };
                /**
                ...
                var sums = this.markerClusterer_.getCalculator()(this.markers_, this.markerClusterer_.getMarkerWeights());
                ...
                var stateControl = markerClusterer.getStateControl();
                        stateControl.addCurrentState(this.map_.getCenter(), this.map_.getZoom())

                        // Zoom into the cluster.
                        this.map_.fitBounds(this.cluster_.getBounds());
                        // anirudhp - increase the zoom by one level
                        /*
                        ...
                        var div = document.createElement('DIV');
                                ...
                                div.innerHTML = '<div id="content" style="font-family:Arial,sans-serif"><div id="bodyContent">'
                                + '<b style="margin-right:0.5em">' + markerClusterer.getClusterMetric() + '</b>'
                        ...
                        /**
                         * The StateControl adds a control to the map that recenters the map
                ...
                function StateControl(stateControlDiv, map, result, markerColumn, colorPallet) {
...
//set Marker DescriptionIcon @Saurabh
                        ...
                        highlightMarkerStateIcon.style.fontSize = "25px";
                        highlightMarkerStateIcon.setAttribute('id', 's');
                        highlightMarkerStateIcon.setAttribute('class', 'ion-information-circled');
//        highlightMarkerStateIcon.click = function()
//        {
//             $("#s").attr("class", "ion-close-round");
//             $(".marker").width("auto");
//             $("#highlightMarkerState").height("30%");
//        }
                        highlightMarkerStateIcon.setAttribute('onClick', 'filterMarkerSlider()');
                        // highlightMarkerStateIcon.setAttribute('onmouseleave', 'filterMarkerSlider()');
                ...
                html = '<div style="font-family:Arial,sans-serif";><p><img src="' +
                        result + "3-dot.png" + '""> High ' + markerColumn + '</p><p><img src="' +
                        result + "2-dot.png" + '"">  Medium ' + markerColumn + '</p><p><img src="' +
                        result + "1-dot.png" + '"">  Low ' + markerColumn + '</p>';
                }
                else {
                html = '<div style="font-family:Arial,sans-serif;">' +
                        '<p>' +
                        '<img src="' + result + '5-dot.png"> Very High ' + markerColumn + '</p>' +
                        '<p>' +
                        '<img src="' + result + '4-dot.png"> High ' + markerColumn + '</p>' +
                        '<p>' +
                        '<img src="' + result + '3-dot.png"> Medium ' + markerColumn + '</p>' +
                        '<p>' +
                        '<img src="' + result + '2-dot.png">  Low ' + markerColumn + '</p>' +
                        '<p>' +
                        '<img src="' + result + '1-dot.png">  Very Low ' + markerColumn + '</p>';
                }
                document.getElementById("filterMarker").innerHTML = html;
                        ...
                        /*goPreviousStateUI.style.backgroundColor = '#ffffff';
                         goPreviousStateUI.style.border = '2px solid #ffffff';
                         goPreviousStateUI.style.borderRadius = '3px';
                         goPreviousStateUI.style.boxShadow = '0 2px 6px rgba(0,0,0,.3)';
                         goPreviousStateUI.style.cursor = 'pointer';
                         goPreviousStateUI.style.marginBottom = '5px';
                         goPreviousStateUI.style.marginRight = '10px';
                         goPreviousStateUI.style.width = '40px';
                         goPreviousStateUI.style.height = '25px';
                         goPreviousStateUI.style.textAlign = 'center';*/
                        ...
                        /*goPreviousStateIcon.style.paddingLeft = '5px';
                         goPreviousStateIcon.style.paddingRight = '5px';*/
                        ...
                        goPreviousStateIcon.onclick = function () {

                        var lastZoom = control.stateStack_[control.stateStack_.length - 2].zoom;
                                var center = control.stateStack_[control.stateStack_.length - 2].center;
                                var previousState = control.getPreviousState();
                                if (previousState != undefined)
                        {
                        map.setCenter(center);
                                map.setZoom(lastZoom);
                                // console.log("Last Zoom", previousState.zoom)
                                // map.setCenter(previousState.center);
                                // map.setZoom(previousState.zoom);
                        }
                        if (control.getNumberOfStates() == 1) {
...
//    });
                 ...
                 * @private
                 */
                StateControl.prototype.stateStack_ = [];
                        /**
                         * Gets the maps previous state.
                         * @return {?google.maps.LatLng, number}
                         */
                        StateControl.prototype.getPreviousState = function() {
                         ...
                         * @return {number}
                         */
                        StateControl.prototype.getNumberOfStates = function() {
                         ...
                         * @param {number} zoom
                         */
                        StateControl.prototype.addCurrentState = function(center, zoom)
                        {
                        if (this.stateStack_.length > 0)
                        {
                        var length = this.stateStack_.length;
                                var lastZoom = this.stateStack_[length - 1].zoom;
                                if (lastZoom != zoom){
                        this.stateStack_.push({"center": center, "zoom": zoom});
                        }
                        ...
                        var goPreviousStateIcon = document.getElementById('goPreviousStateIcon');
                                //goPreviousStateIcon.style.color = '#000000';
